  ...
  return (
    <div id="projects">
      ...
      <div className="card-container">
        <div className="card">
          <div className="card-img">
            <a href="https://github.com/ansarahmed97/iNotebook" target="_blank" rel="noopener noreferrer">
              <img src={process.env.PUBLIC_URL + '/iNotebook.svg'} alt="..." title="Open in GitHub to view source code" />
            </a>
          </div>
        ...
        <div className="card">
          <div className="card-img">
            <a href="https://github.com/ansarahmed97/newsapp" target="_blank" rel="noopener noreferrer"><img src={process.env.PUBLIC_URL + '/allnews.svg'} alt="..." title="Open in GitHub to view source code" /></a></div>
          <div className="card-body">
        ...
        <div className="card">
          <div className="card-img">
            <a href="https://github.com/ansarahmed97/textutils" target="_blank" rel="noopener noreferrer"><img src={process.env.PUBLIC_URL + '/textutils.svg'} alt="..." title="Open in GitHub to view source code" /></a></div>
          <div className="card-body">
        ...
        <div className="card">
          <div className="card-img">
            <a href="https://github.com/ansarahmed97/myblog" target="_blank" rel="noopener noreferrer"><img src={process.env.PUBLIC_URL + '/blog.svg'} alt="..." title="Open in GitHub to view source code" /></a></div>
          <div className="card-body">
        ...
        <div className="card">
          <div className="card-img">
            <a href="https://github.com/ansarahmed97/todolist" target="_blank" rel="noopener noreferrer"><img src={process.env.PUBLIC_URL + '/todolist.svg'} alt="..." title="Open in GitHub to view source code" /></a></div>
          <div className="card-body">
        ...
        <div className="card">
          <div className="card-img">
            <a href="https://github.com/ansarahmed97/simonsgame" target="_blank" rel="noopener noreferrer"><img src={process.env.PUBLIC_URL + '/simonsgame.svg'} alt="..." title="Open in GitHub to view source code" /></a></div>
          <div className="card-body">
        ...
        <div className="card">
          <div className="card-img">
            <a href="https://github.com/ansarahmed97/tindogbyansar" target="_blank" rel="noopener noreferrer"><img src={process.env.PUBLIC_URL + '/tindog.svg'} alt="..." title="Open in GitHub to view source code" /></a></div>
          <div className="card-body">
        ...
        <div className="card">
          <div className="card-img">
            <a href="https://github.com/ansarahmed97/DrumKit" target="_blank" rel="noopener noreferrer"><img src={process.env.PUBLIC_URL + '/drumkit.svg'} alt="..." title="Open in GitHub to view source code" /> </a></div>
          <div className="card-body">
